...
class Experience(object):
    ...
    def sample(self, n):
        ...
        encoded = [Variable(np.array(self.voc.encode(''.join(tokenized_i), add_special_tokens=False))) for tokenized_i in tokenized]
        encoded = MolData.collate_fn(encoded).to(torch.long)
